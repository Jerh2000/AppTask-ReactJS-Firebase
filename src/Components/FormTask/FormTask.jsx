...
class FormTasks extends Component {
  ...
  addTask() {
    if (this.inputTitle.value == "" || this.inputAuthor.value == "" || this.inputEstimatedTime.value == '' || this.textDescription.value == '' || this.inputPriority.value == '') {
      ...
      this.textDescription.value = "";
      this.inputPriority.value = "";
      alert('Su tarea ha sido agregada')
    }
  }
  render() {
    return (
      <div className="container col-12 cardForm form-fixe">
        <h1 className="display-4 text-center">New Task</h1>

        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="tasktitle" className="lead">
              Task title
            </label>
            <input
              required
          ...
          <div class="form-group col-md-6">
            <label for="responsable" className="lead">
              Responsable
            </label>
            <input
              required
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="estimatedtime" className="lead">
              Estimated Time (days)
            </label>
            <input
              required
              ...
              ref={(input) => {
                this.inputEstimatedTime = input;
              }}
            />
          </div>

          <div class="form-group col-md-6">
            <label for="priority" className="lead">
              Priority
            </label>
            <select
              required
